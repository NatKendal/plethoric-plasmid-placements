...
class BinaryNoisyOrCPD(TabularCPD):
    ...
    values: 2D array, 2D list, or 2D tuple (length exactly 2)
        Base probability for this variable being zero or one.
        If there is evidence, this is treated as an additional incoming OR'ed variable.
    ...
    """
    def __init__(self, variable, values, evidence=None, evidence_noise=None, maxTableSize=257, state_names={}):
        ...
        values = [[values[0][0]/total], [values[1][0]/total]]

        # Initialize superclass.
        super().__init__(variable, 2, values, evidence=None, evidence_card=None, state_names=restricted_state_names)
